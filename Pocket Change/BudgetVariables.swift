...
class BudgetVariables: UIViewController
{
    ...
    class func pastXMonths(X: Int) -> [String]
    {
        ...
        // Loop through each month starting from 11 months ago, and append the string associated with the value
        for _ in 1 ... X
        {
    ...
    class func amountSpentInThePast(interval: String) -> [Double]
    {
        ...
        for _ in 1 ... size
        {
            ...
            // Increment the starting point by adding one day
    ...
    // Grab the amount spent in the past 12 months
    class func amountSpentInThePast12Months() -> [Double]
    {
        ...
        for _ in 1 ... 12
        {
            ...
            // Increment the starting point by one month
    ...
    class func logTodaysSpendings(num: Double)
    {
        ...
        let monthKey = BudgetVariables.todaysDate(format: "MM/YYYY")
        ...
        if BudgetVariables.budgetArray[BudgetVariables.currentIndex].amountSpentOnDate[monthKey] == nil
        {
            BudgetVariables.budgetArray[BudgetVariables.currentIndex].amountSpentOnDate[monthKey] = 0.0
        }
        ...
        let newMonthAmount = BudgetVariables.budgetArray[BudgetVariables.currentIndex].amountSpentOnDate[monthKey]! + num
        BudgetVariables.budgetArray[BudgetVariables.currentIndex].amountSpentOnDate[monthKey] = newMonthAmount
    }
